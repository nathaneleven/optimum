...
const Hero = () => {
    return (
        ...
        <Box p={["4","5","6","7","8"]}  w={["100%","100%","100%","100%","75%"]} m="auto">
            ...
            Get the most of fiber internet with Optimum
            </Heading>
            <List color="#000000"spacing={2}>
                <ListItem>
                    <ListIcon as={CheckIcon}  />
                    New fiber internet plans 
                </ListItem>
                <ListItem>
                    <ListIcon as={CheckIcon} />
                    No data caps 
        ...
        <AspectRatio w={["100%","100%","100%","100%","100%"]} mb={["10px","20px","30px","30px","50px"]} ratio={[3, 3, 3, 3, 6/4]} >
            <Image objectPosition={["0 -90px","0 -70px","0 -100px","0 -120px", "0px"]} borderRadius={{xl: "0 0 0 70px"}} src="/hero-optimum-image.jpg" alt="Hero Image Optimum" />
        </AspectRatio>
        </Flex>
        </Stack>
        </>
